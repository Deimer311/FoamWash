// =============================================================================
// ARCHIVO  : acciones-rapidas.jsx
// PROYECTO : FoamWash
// RUTA     : src/components/admin/acciones-rapidas.jsx
// AUTOR    : Cristian Andrés Criollo Tovar
// FECHA    : 15-03-2026
// -----------------------------------------------------------------------------
// DESCRIPCIÓN:
//   Componente de acciones rápidas del panel admin con acceso a modales de gestión.
// =============================================================================

import React, { useState } from 'react';

// Importar los componentes modales
import NuevoUsuarioModal from '../modales/NuevoUsuarioModal';
import ReportesModal from '../modales/ReportesModal';
import ConfiguracionModal from '../modales/ConfiguracionModal';
import GestionEmpleadosModal from '../modales/GestionEmpleadosModal';
import FinanzasModal from '../modales/FinanzasModal';
