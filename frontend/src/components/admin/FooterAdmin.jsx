...
const FooterAdmin = ({
  ...
  const navIcon = (type) => {
    ...
    switch (type) {
      case 'panel':
        return <svg {...props}><rect x="3" y="3" height="7"/><rect x="14" y="3" height="7"/><rect x="3" y="14" height="7"/><rect x="14" y="14" height="7"/></svg>;
      case 'agenda':
        return <svg {...props}><rect x="3" y="4" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>;
      case 'empleados':
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
            <div style={{
              ...
              <svg height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
            <div style={{
              ...
              <svg height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="11" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0110 0v4"/>
              </svg>
            </div>
            <div>
              <h3 style={{ fontSize: '14px', fontWeight: '600', color: '#F1F5F9', marginBottom: '2px' }}>
