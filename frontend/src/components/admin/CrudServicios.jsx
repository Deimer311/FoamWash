...
const IcBroom = () => <svg height="20" viewBox="0 0 24 24" fill="none" stroke="#0066ff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 19l4-4"/><path d="M9.5 9.5L15 4l5 5-5.5 5.5"/><path d="M3 21l6-6"/><path d="M9 15l3-3"/></svg>;
    ...
    const guardarServicio = async () => {
        try {
            ...
            if (imageFile && servicioId) {
                ...
                // El backend retorna { success: true, url: '/uploads/...' }
                const newUrl = imgRes.data?.url || imgRes.data?.data?.imagen_url;
                if (newUrl) {
                    currentServicio.imagen = newUrl + '?t=' + new Date().getTime();
                }
            }
