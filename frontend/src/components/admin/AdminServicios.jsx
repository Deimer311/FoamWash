      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={onClose} style={{
            ...
            onMouseEnter={e => e.currentTarget.style.borderColor = '#bbb'}
            onMouseLeave={e => e.currentTarget.style.borderColor = T.border}>
            <svg height="16" viewBox="0 0 24 24" fill="none"
    ...
    >
      ...
      <div style={{ position: 'relative', flexShrink: 0 }}>
        <div style={{ width: '100%', height: '190px', overflow: 'hidden', background: T.bgSecondary }}>
          {!imgError ? (
            ...
            <div style={{
              ...
              <svg height="40" viewBox="0 0 24 24" fill="none" stroke={T.border} strokeWidth="1.2">
                <rect x="3" y="3" height="18" rx="2"/>
        ...
        <div style={{
          ...
          <svg height="12" viewBox="0 0 24 24" fill="none"
      ...
      <div style={{ padding: '18px 18px 0', display: 'flex', flexDirection: 'column', gap: '10px', flex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
          <div style={{
            ...
            <svg height="11" viewBox="0 0 24 24" fill="none"
      ...
      <div style={{ padding: '14px 18px 18px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <button onClick={() => onEditar(servicio)} style={{
          ...
          <svg height="14" viewBox="0 0 24 24" fill="none"
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              <div style={{
                ...
                <svg height="22" viewBox="0 0 24 24" fill="none"
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap', marginBottom: '1.75rem' }}>
            ...
            <div style={{ position: 'relative', flex: 1, minWidth: '200px', maxWidth: '300px' }}>
              <svg style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)' }} height="14" viewBox="0 0 24 24" fill="none"
