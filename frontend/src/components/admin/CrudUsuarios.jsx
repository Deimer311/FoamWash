// =============================================================================
// ARCHIVO  : CrudUsuarios.jsx
// PROYECTO : FoamWash
// RUTA     : src/components/admin/CrudUsuarios.jsx
// AUTOR    : Cristian Andrés Criollo Tovar
// FECHA    : 15-03-2026
// -----------------------------------------------------------------------------
// DESCRIPCIÓN:
//   CRUD de usuarios: listar, editar y hacer soft-delete de cuentas.
// =============================================================================

import React, { useState, useEffect } from 'react';
import './estilos_admin/CrudUsuarios.css';
...
const CrudUsuarios = () => {
    ...
    const eliminarUsuario = async (id) => {
        if (window.confirm('¿Estás seguro de eliminar este usuario?')) {
            try {
                await api.delete('/usuarios/' + id);  // soft-delete: cambia estado a 'inactivo' en backend
