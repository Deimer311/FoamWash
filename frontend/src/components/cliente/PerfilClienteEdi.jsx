...
const IconUser = ({ size = 18, color = 'currentColor' }) => (
    <svg height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const IconCheck = ({ size = 18, color = 'white' }) => (
    <svg height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
...
const IconUpload = ({ size = 32, color = 'currentColor' }) => (
    <svg height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const IconSpinner = ({ size = 16 }) => (
    <svg height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
