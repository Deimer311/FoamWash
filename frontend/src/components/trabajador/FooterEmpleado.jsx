                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <svg height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div style={{
                ...
                <div>
                    <h3 style={{
                        ...
                        <svg height="16" viewBox="0 0 24 24" fill="none" stroke="#60A5FA" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        {[
                            {
                                ...
                                icon: <svg height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" height="7"/><rect x="14" y="3" height="7"/><rect x="14" y="14" height="7"/><rect x="3" y="14" height="7"/></svg>
                            },
                            {
                                name: 'Agenda', 
                            ...
                            },
                            {
                                name: 'Perfil', 
                                onClick: onGoPerfil,
                                icon: <svg height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="8" r="4"/></svg>
                            }
                        ].map((link, index) => (
                            <li key={index}>
                                <a
                ...
                <div>
                    <h3 style={{
                        ...
                        <svg height="16" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
