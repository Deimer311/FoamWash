// =============================================================================
// ARCHIVO  : PerfilTrabajadorEdi.jsx
// PROYECTO : FoamWash
// RUTA     : src/components/trabajador/PerfilTrabajadorEdi.jsx
// AUTOR    : Cristian Andrés Criollo Tovar
// FECHA    : 15-03-2026
// -----------------------------------------------------------------------------
// DESCRIPCIÓN:
//   Formulario de edición del perfil del trabajador: datos, foto, horario, especialidades y certificaciones.
// =============================================================================
...
const PerfilTrabajadorEdi = ({ onBackToProfile }) => {
    ...
    // FIX: /empleados/:id/perfil no existe → usar GET /empleados (lista)
    // =========================================================================
    useEffect(() => {
        if (!user?.id) return;
        fetchPerfil();
    ...
    const fetchPerfil = async () => {
        setIsLoading(true);
        try {
            // FIX: usar GET /empleados y encontrar el empleado actual en la lista
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // FIX: /empleados/:id/perfil no existe → usar PUT /usuarios/:id
            // foto_perfil NO se incluye aquí para no sobreescribir con null
