              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                                    ...
                                    : (_buildFotoUrl(_fotoUrl).isNotEmpty
                                        ? Image.network(
                                            ...
                                            errorBuilder: (_, __, ___) =>
                                                const Icon(Icons.badge, size: 50, color: Color(0xFF1A56FF)),
                                          )
                                        : const Icon(Icons.badge, size: 50, color: Color(0xFF1A56FF))),
                              ),
                            ),
                    ...
                    // ── Datos Personales ───────────────────────────
                    _sectionTitle('Datos Personales', Icons.person),
                    ...
                    // ── Datos Laborales ────────────────────────────
                    _sectionTitle('Datos Laborales', Icons.work),
                    const SizedBox(height: 12),
    ...
    return Row(
      children: [
        Container(
          width: 32, height: 32,
          decoration: BoxDecoration(
            gradient: const LinearGradient(colors: [Color(0xFF1A56FF), Color(0xFF7C3AED)]),
        ...
        Text(title,
          style: const TextStyle(
            fontSize: 16, fontWeight: FontWeight.w700, color: Color(0xFF0A1435),
          )),
      ],
    );
  }
