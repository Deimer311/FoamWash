...
// ARCHIVO  : Footer1.jsx
// PROYECTO : FoamWash
// RUTA     : src/components/comun/Footer1.jsx
// AUTOR    : Cristian Andrés Criollo Tovar
// FECHA    : 15-03-2026
// -----------------------------------------------------------------------------
// DESCRIPCIÓN:
//   Footer alternativo usado en páginas del cliente autenticado.
// =============================================================================
...
const Footer = () => {
    ...
    return (
        <footer style={{
            width: '100%',
            backgroundColor: '#0F172A', // Azul oscuro casi negro
            color: '#E2E8F0', // Gris claro
            marginTop: 'auto'
        }}>
            {/* Sección superior con información de contacto */}
            <div style={{
                backgroundColor: '#1E293B', // Azul gris oscuro
            ...
            <div style={{
                ...
                <div>
                    <h3 style={{
                        ...
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#60A5FA" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="16.24,7.76 11.88,16.24 7.76,16.24 12.12,7.76" fill="#60A5FA" stroke="none"/></svg>
                        enlaces Rápidos
                        <div style={{
                            position: 'absolute',
                            bottom: 0,
                    ...
                    <ul style={{
                        ...
                        {[
                            ...
                            },
                            {
                                ...
                                icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg>
                            },
                            {
                ...
                <div>
                    <h3 style={{
                        ...
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#60A5FA" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg>
                        Nuestros Servicios
                        <div style={{
                            position: 'absolute',
                            bottom: 0,
                        ...
                        {[
                            {
                                ...
                                icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 11V5a2 2 0 012-2h14a2 2 0 012 2v6"/><path d="M3 11h18"/><path d="M3 11v7a2 2 0 002 2h14a2 2 0 002-2v-7"/><line x1="7" y1="20" x2="7" y2="22"/><line x1="17" y1="20" x2="17" y2="22"/></svg>
                            },
                            {
                                name: 'Lavado de Alfombras',
                                icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/><line x1="2" y1="14" x2="22" y2="14"/></svg>
                            },
                            {
                                name: 'Lavado de Colchones',
                                icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 13h18v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6z"/><path d="M3 13V8a2 2 0 012-2h14a2 2 0 012 2v5"/><line x1="7" y1="21" x2="7" y2="23"/><line x1="17" y1="21" x2="17" y2="23"/></svg>
                            },
                            {
                                name: 'Tapicería de Carros',
                                icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 17H3a2 2 0 010-4l1-6a2 2 0 012-2h10l3 4h2a2 2 0 012 2v4a2 2 0 01-2 2h-2"/><circle cx="7.5" cy="17.5" r="1.5"/><circle cx="16.5" cy="17.5" r="1.5"/></svg>
                            },
                            {
                                name: 'Limpieza de Cortinas',
                                icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="2" y1="3" x2="22" y2="3"/><path d="M2 3v1c0 4 4 7 4 7v8a1 1 0 001 1h10a1 1 0 001-1v-8s4-3 4-7V3"/><line x1="8" y1="21" x2="16" y2="21"/></svg>
                            },
                            {
                                name: 'Mantenimiento de Pisos',
                                icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="14" width="20" height="8" rx="1"/><line x1="2" y1="18" x2="22" y2="18"/><line x1="8" y1="14" x2="8" y2="22"/><line x1="16" y1="14" x2="16" y2="22"/></svg>
                            }
                        ].map((servicio, index) => (
                            <li key={index} style={{
                                fontSize: '14px',
                ...
                <div>
                    <h3 style={{
                        ...
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#60A5FA" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                        Newsletter
                        <div style={{
                            position: 'absolute',
                            bottom: 0,
