...
import './css/estilos_cotizar.css'; 

// =======================================================
// DATOS DE SERVICIOS (Extraídos del HTML original)
// =======================================================
const serviceData = [
  { id: 1, imagen: "/img/serv_lavado_muebles.jpg", title: "Lavado de muebles", 
    desc: "Lavado profundo de sofás y sillas, eliminación de manchas y olores.", price: "$90.000" },
  { id: 2, imagen: "/img/serv_alfombras.jpg", title: "Lavado de alfombras", 
    desc: "Limpieza profunda para alfombras pequeñas y medianas.", price: "$50.000" },
  { id: 3, img: "/img/serv_tapiceria_carro.jpg", title: "Tapicería de carros", 
    desc: "Limpieza interior del vehículo: asientos, alfombras y paneles.", price: "$140.000" },
  { id: 4, img: "/img/serv_cortinas.jpg", title: "Lavado de cortinas", 
    desc: "Lavado y planchado ligero para cortinas y visillos.", price: "$80.000" },
  { id: 5, img: "/img/serv_colchones.jpg", title: "Lavado de colchones", 
    desc: "Eliminación de ácaros y manchas, desodorización y secado rápido.", price: "$90.000" },
  { id: 6, img: "/img/serv_desinfeccion.jpg", title: "Desinfección y sanitización", 
    desc: "Servicio rápido de desinfección para hogares y oficinas.", price: "$150.000" }
];
  ...
  return (
    <>
      ...
      <header className="header-banner">
        {/* <img src="/public/fondo.png" alt="Fondo encabezado" className="fondo" /> */}
        ...
        <nav className="nav-bar">
          ...
          <a href="/servicios.html" className="nav-link">Agendar</a> {/*DEBE MODIFICARSE PARA QUE FUNCIONE EL ENLACE CORRECTAMENTE*/}
          <a 
