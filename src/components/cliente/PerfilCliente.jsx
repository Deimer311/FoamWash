/**
 * ============================================================================
 * PERFILCLIENTE.JSX — Datos reales desde la BD
 * ============================================================================
 */
                        ...
                        <div className="profile-details">
                            ...
                            <div className="detail-card" style={{ opacity: 0, transform: 'translateY(20px)', transition: 'all 0.3s ease' }}>
                                ...
                                <div className="info-grid">
                                    ...
                                    <div className="info-item">
                                        ...
                                        <div className="info-value">{perfil?.tipo_documento || '—'}</div>
                                    </div>
                                    <div className="info-item">
                            ...
                            <div className="detail-card" style={{ opacity: 0, transform: 'translateY(20px)', transition: 'all 0.3s ease' }}>
                                ...
                                <div className="activity-list">
                                    {perfil?.actividad_reciente?.length > 0 ? (
                                        perfil.actividad_reciente.map((item, i) => (
                                            <div key={i} className="activity-item">
                                                <div className="activity-icon">🧹</div>
                                                <div className="activity-content">
                                                    <div className="activity-title">{item.Nombre_Servicio || 'Servicio'}</div>
