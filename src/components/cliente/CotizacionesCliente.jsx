/**
 * ============================================================================
 * CotizacionesCliente.jsx — Versión conectada a BD
 * ============================================================================
 * CAMBIOS respecto a la versión anterior:
 *  • Los servicios se cargan desde /api/cotizaciones/servicios (no hardcoded)
 *  • Al "Confirmar Pedido" se crea la reserva en /api/reservas (con empleado
 *    asignado automáticamente) y las cotizaciones en /api/cotizaciones
 *  • Anti-duplicado: el backend maneja que no se inserte dos veces
 *  • Si el usuario NO está logueado, el carrito se guarda en localStorage
 *    (cotizacionStorage) y se sincroniza al hacer login
 *  • Diseño 100% intacto
 * ============================================================================
 */
...
import { useCarrito } from '../modals/CarritoContext';
import ServiceCardCliente   from './ServiceCardCliente';
import Footer               from '../global/Footer1';
import BotonCarritoFlotante from '../modals/BotonCarritoFlotante';
