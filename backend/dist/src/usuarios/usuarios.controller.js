...
const UPLOADS_PATH = (0, path_1.join)(process.cwd(), 'uploads', 'perfiles');
...
__decorate([
    ...
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
    (0, swagger_1.ApiOperation)({ summary: 'Usuarios agrupados por rol (admin)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
    (0, swagger_1.ApiOperation)({ summary: 'Empleados activos (admin)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Historial de reservas de un cliente' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(self_or_admin_guard_1.SelfOrAdminGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Subir foto de perfil de un usuario' }),
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('foto', {
        storage: (0, multer_1.diskStorage)({
            ...
            filename: (req, file, cb) => {
                ...
                const uniqueName = `perfil-${userId}-${Date.now()}${(0, path_1.extname)(file.originalname)}`;
                cb(null, uniqueName);
            },
        }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('admin'),
    (0, swagger_1.ApiOperation)({ summary: 'Desactivar (soft delete) un usuario (admin)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
