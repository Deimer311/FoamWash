...
exports.EstadisticasModule = EstadisticasModule = __decorate([
    (0, common_1.Module)({ controllers: [estadisticas_controller_1.EstadisticasController], providers: [estadisticas_service_1.EstadisticasService, roles_guard_1.RolesGuard] })
], EstadisticasModule);
