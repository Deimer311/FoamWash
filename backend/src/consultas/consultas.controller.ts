...
export class ConsultasController {
  ...
  @ApiOperation({ summary: 'Servicios por cliente' })
  async c3() {
  ...
  @ApiOperation({ summary: 'Agenda del empleado' })
  ...
  @ApiOperation({ summary: 'Clientes de la semana' })
  async c5() {
  ...
  @ApiOperation({ summary: 'Reservas por servicio' })
  async c6() {
  ...
  @ApiOperation({ summary: 'Reservas por cliente' })
  async c7() {
  ...
  @ApiOperation({ summary: 'Empleados con servicios del mes' })
  async c8() {
  ...
  @ApiOperation({ summary: 'Empleados sin servicios' })
  async c9() {
  ...
  @ApiOperation({ summary: 'Agenda semanal completa' })
  async c10() {
  ...
  @Get('todas')
  @ApiOperation({ summary: 'Todas las consultas' })
  async todas() {
