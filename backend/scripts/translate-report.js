...
const translations = [
  ...
  { from: />Test Suites Total</g, to: ">Total de Suites<" },
  { from: />Tests Total</g, to: ">Total de Pruebas<" },
  { from: />Failed Suites</g, to: ">Suites Fallidas<" },
  { from: />Failed Tests</g, to: ">Pruebas Fallidas<" },
  { from: />Pending Suites</g, to: ">Suites Pendientes<" },
  { from: />Pending Tests</g, to: ">Pruebas Pendientes<" },
  { from: />Information</g, to: ">Información<" },
  { from: />Suite Time</g, to: ">Tiempo por Suite<" },
  { from: />Timing Ratio</g, to: ">Proporción de Tiempos<" },
  { from: />StartTime</g, to: ">Hora de Inicio<" },
  { from: />Time</g, to: ">Tiempo Total<" },
  { from: />RootDir</g, to: ">Directorio Raíz<" },
  { from: />MaxWorkers</g, to: ">Trabajadores Máximos<" },
